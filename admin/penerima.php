    ...
    <div class="content-wrapper">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button type="button" href="#" name="profile" data-toggle="modal" data-target="#karyawanTokoModal" class="btn btn-info float-right"><i class="fas fa-plus"></i> Tambah Penerima</button>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="#" class='btn btn-sm btn-warning shadow-sm open_modal' id='<?php echo $data['id_penerima']; ?>'>Hapus </a>
                  </td>
                </tr>
              <?php
          ...
          <div class="modal-body">
            <form action="../sql_query.php" enctype="multipart/form-data" method="POST">
              <fieldset>
                ...
                <div class="form-group">
                  <select class="form-control" id="id_bantuan" name="id_bantuan">
                    <option>---- Pilih Kode Bantuan ----</option>
                    <?php
                    $userr = mysqli_query($conn, "Select * from tb_bantuan where kuota_bantuan > 0");
                    // Query untuk menampilkan semua data anggota
                    if (mysqli_num_rows($userr) == 0) {
                      echo "<option>Tidak ada </option>";
                    } else {
                ...
                <div class="modal-footer">
                  ...
                  <button id="tambahPenerima" name="tambahPenerima" type="submit" class="btn btn-success">Simpan</button>
                </div>
              </fieldset>
            </form>
          </div>
