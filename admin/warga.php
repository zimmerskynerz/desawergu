...
<head>
	...
	<title>PEMDES KAYEN || PETUGAS</title>
	<!-- DataTables -->
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark">DATA WARGA DESA WERGU WETAN</h1>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
			</div>
			...
			<div class="card">
				<div class="card-header">
					<button type="button" href="#" name="profile" data-toggle="modal" data-target="#karyawanTokoModal" class="btn btn-info float-right"><i class="fas fa-plus"></i> Tambah Warga</button>
				</div>
				<!-- /.card-header -->
				<div class="card-body">
					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							<?php
							$sql_tampil = "select *, tb_pendidikan.jenjang_pendidikan as pendidikan
								from tb_warga join tb_pendidikan on tb_pendidikan.id_pendidikan=tb_warga.id_pendidikan";
							...
							?>
								<tr>
									...
									<td><?php echo $data['jpekerjaan'] ?></td>

									<td>
										<a href="#" class='btn btn-sm btn-warning shadow-sm open_modal' id='<?php echo $data['nik']; ?>'>Detail </a>
									</td>
								</tr>
							<?php
					...
					<div class="modal-body">
						<form action="../sql_query.php" enctype="multipart/form-data" method="POST">
							<fieldset>
								...
								<div class="form-group">
									<input type="text" name="nm_lengkap" class="form-control" id="nm_lengkap" placeholder="Nama Lengkap" required>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<input type="text" name="jpekerjaan" class="form-control" id="jpekerjaan" placeholder="Pekerjaan" required>
								</div>
								<div class="form-row">
								...
								<div class="modal-footer">
									...
									<button id="tambahWarga" name="tambahWarga" type="submit" class="btn btn-success">Simpan</button>
								</div>
							</fieldset>
						</form>
					</div>
