          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              $sql_tampil = "SELECT *, tb_penerima.no_kk as no_kk,tb_kk.nik_kepala as nik_kepala,tb_kk.nm_kepala as nm_kepala,
								...
								where tb_user.username='$session_id' and tb_penerima.status='INFO'";
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="#" class='btn btn-sm btn-warning shadow-sm open_modal' id='<?php echo $data['id_penerima']; ?>'>KONFIRMASI </a>
                  </td>
                </tr>
              <?php
