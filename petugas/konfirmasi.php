    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">DATA BANTUAN KONFIRMASI</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              $sql_tampil = "SELECT *, tb_penerima.no_kk as no_kk,tb_kk.nik_kepala as nik_kepala,tb_kk.nm_kepala as nm_kepala,
								...
								where tb_user.username='$session_id' and tb_penerima.status='KONFIRMASI'";
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="#" class='btn btn-sm btn-danger shadow-sm open_modal' id='<?php echo $data['id_penerima']; ?>'>PROSES </a>
                  </td>
                </tr>
              <?php
