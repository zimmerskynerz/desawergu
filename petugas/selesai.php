    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">DATA BANTUAN SELESAI</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $sql_tampil = "SELECT *,tb_penerima.id_penerima as id_penerima, tb_penerima.no_kk as no_kk,tb_kk.nik_kepala as nik_kepala,tb_kk.nm_kepala as nm_kepala,
								...
								where tb_user.username='$session_id' and tb_penerima.status='SELESAI'";
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="cetak.php?id_penerima=<?php echo $data['id_penerima']; ?>" class='btn btn-sm btn-warning shadow-sm' type="submit" value="<?php echo $data['id_penerima']; ?>" id="<?php echo $data['id_penerima']; ?>">CETAK </a>
                  </td>
                </tr>
              <?php
